...
\begin{longtable}{  p{7.5cm}  p{7cm} }
  ...
  \code{mode gm|master|slave} & (legacy) is now an alias of the \texttt{ptp}
    command \\
  ...
  \code{ptp abscal} & sets WRPC for absolute calibration.  You need special
    hardware for this process, which is described in
